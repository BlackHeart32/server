...
public class ServerResource {
    ...
    public byte[] getServerImage(@PathVariable("fileName") String fileName) throws IOException {
        //return Files.readAllBytes(Paths.get((System.getProperty("user.home") + "/Downloads/ServerPNG/" + fileName)));
        System.out.println(System.getProperty("user.home"));
        return Files.readAllBytes(Paths.get("D:/ImageRes/ServerPNG/" + fileName));
